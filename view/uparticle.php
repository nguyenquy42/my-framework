...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $model->upArticle($title,$content,$author_id,$status, $id);
}
            ...
            <div class="col-6 m-auto">
                <form method="post">
                    <div class="form-group">
                        <label>TITLE</label>
                        <input value="<?= $in[1] ?>" type="text" class="form-control" name="title" />
                    </div>
                    <div class="form-group">
                        <label>CONTENT</label>
                        <input value="<?= $in[2] ?>" type="text" class="form-control" name="content" />
                    </div>
                    <div class="form-group">
                        <label>AUTHOR_ID</label>
                        <input value="<?= $in[4] ?>" type="text" class="form-control" name="author_id" />
                    </div>
                    <div class="form-group">
                        <label>STATUS</label>
                        <input value="<?= $in[5] ?>" type="text" class="form-control" name="status" />
                    </div>
