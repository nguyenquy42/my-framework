...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $model->upData($name,$contact,$status, $id);
}
            ...
            <div class="col-6 m-auto">
                <form method="post">
                    <div class="form-group">
                        <label>Name</label>
                        <input value="<?= $in[1] ?>" type="text" class="form-control" name="name" />
                    </div>
                    <div class="form-group">
                        <label>Contact</label>
                        <input value="<?= $in[2] ?>" type="text" class="form-control" name="contact" />
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <input value="<?= $in[3] ?>" type="text" class="form-control" name="status" />
                    </div>
